...
Use these examples to build a Postman collection. Create a collection named *Battlefield Medical AI* and add the three requests above. Use environment variables in Postman for `baseUrl` and `token`.
